...
{
	public sealed class CountFalsesNEQueryParserLISP : CountQueryParserLISP
	{
		#region Constants
		...
		{
			return new CountFalsesNEQueryParserLISP(parser);
		}
		#endregion //Class Methods

		#region Constructors
		public CountFalsesNEQueryParserLISP(QueryParserLISPParser parser)
			: base(parser)
		{
		}
