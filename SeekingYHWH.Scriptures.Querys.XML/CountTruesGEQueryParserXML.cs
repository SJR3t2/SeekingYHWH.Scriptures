...
{
	public sealed class CountTruesGEQueryParserXML : CountQueryParserXML
	{
		#region Constants
		...
		{
			return new CountTruesGEQueryParserXML(parser);
		}
		#endregion //Class Methods

		#region Constructors
		public CountTruesGEQueryParserXML(QueryParserXMLParser parser)
			: base(parser)
		{
		}
