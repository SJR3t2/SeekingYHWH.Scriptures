...
{
	public sealed class CountFalsesLEQueryParserXML : CountQueryParserXML
	{
		#region Constants
		...
		{
			return new CountFalsesLEQueryParserXML(parser);
		}
		#endregion //Class Methods

		#region Constructors
		public CountFalsesLEQueryParserXML(QueryParserXMLParser parser)
			: base(parser)
		{
		}
