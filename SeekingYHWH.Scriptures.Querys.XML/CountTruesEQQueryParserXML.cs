...
{
	public sealed class CountTruesEQQueryParserXML : CountQueryParserXML
	{
		#region Constants
		...
		{
			return new CountTruesEQQueryParserXML(parser);
		}
		#endregion //Class Methods

		#region Constructors
		public CountTruesEQQueryParserXML(QueryParserXMLParser parser)
			: base(parser)
		{
		}
