...
{
	public sealed class ContainsQueryParserXML : QueryParserXML
	{
		#region Constants
		...
		{
			return new ContainsQueryParserXML(parser);
		}
		#endregion //Class Methods

		#region Constructors
		public ContainsQueryParserXML(QueryParserXMLParser parser)
			: base(parser)
		{
		}
		...
		public override bool TryParse(XmlNode config, out QueryProvider provider)
		{
			...
			provider = new ContainsQueryProvider(text);
			return true;
		}
		#endregion //Methods
	}
