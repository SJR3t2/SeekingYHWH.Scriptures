...
{
	public sealed class CountTruesLEQueryParserXML : CountQueryParserXML
	{
		#region Constants
		...
		{
			return new CountTruesLEQueryParserXML(parser);
		}
		#endregion //Class Methods

		#region Constructors
		public CountTruesLEQueryParserXML(QueryParserXMLParser parser)
			: base(parser)
		{
		}
